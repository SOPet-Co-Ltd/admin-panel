...
export const useApproveCustomTag = (
  tagId: string,
  options?: UseMutationOptions<{ tag: CustomTag; message: string }, FetchError, void>
) => {
  return useMutation({
    mutationFn: async () => {
      const response = await sdk.client.fetch<{ tag: CustomTag; message: string }>(
...
export const useAffectedProducts = (
  options?: UseMutationOptions<AffectedProductsResponse, FetchError, { ids: string[] }>
) => {
  return useMutation({
...
export const useDeleteCustomTags = (
  options?: UseMutationOptions<{ deleted: number; message?: string }, FetchError, { ids: string[] }>
) => {
  return useMutation({
    mutationFn: async (payload: { ids: string[] }) => {
      // SDK automatically stringifies objects, so pass the object directly

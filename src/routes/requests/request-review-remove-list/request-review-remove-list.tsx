          ...
          <Table.Body data-testid="request-review-remove-list-table-body">
            {requests?.map(request => {
              ...
              return (
                <Table.Row
                  key={request.id}
                  data-testid={`request-review-remove-list-table-row-${request.id}`}
                >
                  <Table.Cell
                    data-testid={`request-review-remove-list-table-row-${request.id}-submitted-by`}
                  >
                    {request.seller?.name}
                  </Table.Cell>
                  <Table.Cell
                    data-testid={`request-review-remove-list-table-row-${request.id}-reason`}
                  >
                    {requestData.data.reason}
                  </Table.Cell>
                  <Table.Cell
                    data-testid={`request-review-remove-list-table-row-${request.id}-date`}
                  >
                  ...
                  <Table.Cell
                    data-testid={`request-review-remove-list-table-row-${request.id}-status`}
                  >
                    {getRequestStatusBadge(request.status!)}
                  </Table.Cell>
                  <Table.Cell
                    data-testid={`request-review-remove-list-table-row-${request.id}-actions`}
                  >
                    <RequestMenu

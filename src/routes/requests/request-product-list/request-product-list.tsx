...
const ProductRequestsRow = ({
  ...
  return (
    <Table.Row
      key={request.id}
      data-testid={`request-product-list-table-row-${request.id}`}
    >
      <Table.Cell data-testid={`request-product-list-table-row-${request.id}-product`}>
        {requestData.title}
      </Table.Cell>
      <Table.Cell data-testid={`request-product-list-table-row-${request.id}-submitted-by`}>
        {request.seller?.name}
      </Table.Cell>
      ...
      <Table.Cell data-testid={`request-product-list-table-row-${request.id}-status`}>

          ...
          <Table.Body data-testid="request-product-tag-list-table-body">
            {requests?.map(request => {
              ...
              return (
                <Table.Row
                  key={request.id}
                  data-testid={`request-product-tag-list-table-row-${request.id}`}
                >
                  <Table.Cell
                    data-testid={`request-product-tag-list-table-row-${request.id}-value`}
                  >
                    {requestData.value}
                  </Table.Cell>
                  <Table.Cell
                    data-testid={`request-product-tag-list-table-row-${request.id}-submitted-by`}
                  >
                    {request.seller?.name}
                  </Table.Cell>
                  ...
                  <Table.Cell
                    data-testid={`request-product-tag-list-table-row-${request.id}-status`}
                  >
                    {getRequestStatusBadge(request.status!)}
                  </Table.Cell>
                  <Table.Cell
                    data-testid={`request-product-tag-list-table-row-${request.id}-actions`}
                  >
                    <RequestMenu
